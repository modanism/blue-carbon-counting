import OnProgress from "@/app/components/onprogress/OnProgress";
  ...
  return (
    <main className="flex min-h-screen flex-col items-start px-[112px] bg-[#FAFAFA] pt-[150px] gap-[21px]">
      ...
      <p className="text-[16px] text-[#1A202C] mb-[75px]">
        ...
        arcu non sodales neque sodales. <br></br><br></br>
        ...
        lacus vel facilisis volutpat est.<br></br><br></br>
